  ...
  <div class="t-listing">
    ...
    <div class="tourney-list">
      <div class="tourney-card" v-for="tourney in tournaments" :key="tourney">
        <div
          class="tourney-banner round-border"
          :style="'--bg-url:url(' + tourney.bannerUrl + ')'"
        >
          <div class="tags">
            <BadgeText
              v-for="tag in tourney.tags"
              :text="tag"
              :thinMode="true"
              :fontColor="'var(--main-font-color)'"
              v-bind:key="tag"
...
export default {
  data() {
    return {
      ...
      featuredDesc:
        "A very cool 4v4 tournament for very pro players!!! Come play and have a good friggin time yes osu",
      tournaments: [
        {
          id: 2,
          name: "Tournament A",
  ...
  > div.featured {
    ...
    > div.featured-banner {
      background-image: linear-gradient(
        ...
        url(https://i.redd.it/5vbatj2sa0s71.png);
